...
function(create_version_file)
    normalize_variable_name(PROJECT_NAME PROJECT_VERSION_NAME)
    set(INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR}/include)
    set(OUT_PATH ${INCLUDE_DIR}/${PROJECT_NAME}/version.h)
    configure_file(${TEMPLATES_DIR}/version.h.in ${OUT_PATH})
    set(${PROJECT_VERSION_NAME}_CONFIGURE_PATH ${INCLUDE_DIR} PARENT_SCOPE)
endfunction()

function(create_symbol_export_file)
    normalize_variable_name(PROJECT_NAME PROJECT_VERSION_NAME)
    set(INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR}/include)
    set(OUT_PATH ${INCLUDE_DIR}/${PROJECT_NAME}/symbol_export.h)
    configure_file(${TEMPLATES_DIR}/symbol_export.h.in ${OUT_PATH})
    set(${PROJECT_VERSION_NAME}_CONFIGURE_PATH ${INCLUDE_DIR} PARENT_SCOPE)
endfunction()

function(create_compile_attributes_file)
    normalize_variable_name(PROJECT_NAME PROJECT_VERSION_NAME)
    set(INCLUDE_DIR ${CMAKE_CURRENT_BINARY_DIR}/include)
    set(OUT_PATH ${INCLUDE_DIR}/${PROJECT_NAME}/compile_attributes.h)
    configure_file(${TEMPLATES_DIR}/compile_attributes.h.in ${OUT_PATH})
    set(${PROJECT_VERSION_NAME}_CONFIGURE_PATH ${INCLUDE_DIR} PARENT_SCOPE)
endfunction()
